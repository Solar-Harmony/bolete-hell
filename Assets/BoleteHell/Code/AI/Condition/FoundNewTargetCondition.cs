...
[Condition(name: "found new target", story: "[SelfCharacter] found a new [target]", category: "Bolete Hell", id: "a6c458a36beedbba632aa9f9dc2a4d70")]
public partial class FoundNewTargetCondition : BoleteCondition
{
    ...
    public override bool IsTrueImpl()
    {
        ...
        if (Target.Value == go.gameObject) return false;

        Debug.Log($"Now targeting {go.gameObject}");
